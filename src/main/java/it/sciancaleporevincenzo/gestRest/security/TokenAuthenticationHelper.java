package it.sciancaleporevincenzo.gestRest.security;
...
class TokenAuthenticationHelper {
    private static final long EXPIRATION_TIME = 1000 * 60 * 420; // 7h
    private static final String SECRET = "TBbqxM4FfBgHz7dEt3h3aMr8rtp+ljGRH12Zr2eYQB4bhX3ZVXSeJUvBCpLax0NoX6F+MkKohKl5hjaBjobrmQ==";
